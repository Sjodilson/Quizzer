...
public class StartGame extends HttpServlet {
    ...
    final static Logger logger = Logger.getLogger(StartGame.class.getName());
    ...
    protected void doGet(
        ...
        try {
            ...
            game.getPlayers().stream().forEach((p) -> {
                game.getScoreboard().AddPlayerToScoreboard(p.getName());
            });
            ...
            Question currentQuestion = currentRound.getQuestions().get(game.getQuestionCount() -1);
